  ...
  return (
    <div className="flex items-stretch justify-center gap-10 px-4 pt-7 pb-3">
      <div className="flex flex-col items-center">
        <span className="text-[13px] font-semibold text-muted-foreground tracking-wider uppercase mb-0.5">アクティブDAY</span>
      ...
      <div className="flex flex-col items-center">
        <span className="text-[13px] font-semibold text-muted-foreground tracking-wider uppercase mb-0.5">連続日数</span>
