...
// Total counter: 1-hour window — counts ALL users who opened the app within the last hour
// (including users with online status hidden — they count as anonymous +1)
const ONLINE_WINDOW = 3600000;
