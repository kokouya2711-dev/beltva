...
function AppLayoutInner() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      {location.pathname === "/" ? (
        <header className="md:hidden sticky top-0 z-30 flex items-center px-3 py-2.5 transition-transform duration-300 ease-out" style={{ transform: headerHidden ? "translateY(-100%)" : "translateY(0)", border: 'none', background: 'hsl(var(--background))' }}>
